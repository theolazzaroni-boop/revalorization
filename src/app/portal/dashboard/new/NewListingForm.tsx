...
type Category = { value: string; label: string; icon: string; description: string };
...
type FormData = {
  category: string; condition: string; quantity: string;
  unit: string; description: string; locationAddress: string; preferredDate: string;
};

const INITIAL: FormData = {
  category: "", condition: "", quantity: "", unit: "TONNE",
  description: "", locationAddress: "", preferredDate: "",
};

const STEPS = ["Matière", "Quantité", "Détails", "Récapitulatif"];

export default function NewListingForm({ partnerName }: { partnerName: string }) {
      ...
      <div className="text-center py-16">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-sm text-white font-medium transition"
          >
            Voir mes demandes →
          </button>
        </div>
  ...
  return (
    <div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <input
                  type="number" min="0" step="0.1" placeholder="ex: 2.5"
                  value={form.quantity}
      ...
      <div className="flex justify-between mt-6">
        <button
          onClick={() => step === 0 ? router.push("/portal/dashboard") : setStep((s) => s - 1)}
          className="px-5 py-2.5 rounded-xl border border-gray-300 text-sm text-gray-700 hover:bg-gray-50 transition"
        >
          {step === 0 ? "← Mes demandes" : "Retour"}
        </button>
