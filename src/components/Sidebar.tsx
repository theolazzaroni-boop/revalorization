...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`shrink-0 bg-white border-r border-gray-200 flex flex-col transition-all duration-200 ease-in-out ${
    ...
    >
      ...
      <div className="h-16 flex items-center justify-between px-3 border-b border-gray-200 shrink-0">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          {!collapsed && (
            <span className="font-semibold text-gray-900 text-sm truncate">Revalorization</span>
          )}
        </div>
        <button
      ...
      <div className="px-2 py-3 border-t border-gray-200 shrink-0">
        <button
          ...
          className={`flex items-center gap-3 w-full px-2.5 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors ${
            collapsed ? "justify-center" : ""
          }`}
        >
